...
app.layout = html.Div([
    ...
    style = {'textAling': 'center', 'color': '503D36','font-size': 24}),#Include style for title
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
    ...
    # Hint:Use Vehicle_Type and Advertising_Expenditure columns
        ...
        R_chart3 = dcc.Graph(
            ...
            title='Total Advertising Expenditure over Vehicle Type'))
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(yas, x='Year', y='Automobile_Sales', title='Automobile sales per year {}'.format(input_year)))
  ...
  # Plot bar chart for average number of vehicles sold during the given year
    ...
    # Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(
            ...
            names='Vehicle_Type', title='Total Advertising Expenditure for vehicle type {}'.format(input_year)))
